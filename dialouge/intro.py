...
class GameIntroduction:
    ...
    def format_text(self, text, wait):
...
Enter number: """).strip()
            if weapon_choice == "1":
                ...
                self.format_text("You feel the weight of the sword in your hand, the blade gleaming in the torchlight. +4 strength has been added to your stats.", 2)
                break
            elif weapon_choice == "2":
                self.player_inventory.add_weapon("axe", damage=4)
                self.format_text("You feel the weight of the axe in your hand, the blade gleaming in the torchlight. +4 strength has been added to your stats.", 2)
                break
            elif weapon_choice == "3":
                self.player_inventory.add_weapon("bow", damage=4)
                self.format_text("You feel the tension of the bowstring as you draw it back, the arrow poised to strike. +4 strength has been added to your stats.", 2)
                break
            elif weapon_choice == "4":
                self.player_inventory.add_weapon("staff", damage=4)
                self.format_text("You feel the power of the staff coursing through your veins, the magic within it waiting to be unleashed. +2 intelligence has been added to your stats.", 2)
                break
            else:
                self.format_text("That is not a valid weapon choice. Choose again.", 2)
...
You raise your weapon to meet their attack, the clash of steel ringing out through the arena.
    """
        ...
        self.format_text(battle_text, 2)
